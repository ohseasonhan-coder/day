...
const SIGNALS = [
  ...
  { key: '표현·언어', re: /(말|이야기|설명|표현|노래|불렀|생각을|느낌을|소개)/ },
  { key: '또래·관계', re: /(친구|또래|나누|양보|배려|함께하는|주고받|협력)/ },
  { key: '탐색·발견', re: /(탐색|관찰|살펴|비교|궁금|실험|발견|알아 가)/ },
  { key: '자립·자조', re: /(스스로|자조|자립|정리|준비하는|혼자|해 보려)/ },
  { key: '신체·조절', re: /(균형|힘을 조절|움직이|뛰|점프|기어|근육|대근육|소근육)/ },
  { key: '구성·표상', re: /(만들|구성|꾸미|모양|구조물|완성|표상|자기만의 방식)/ },
];
