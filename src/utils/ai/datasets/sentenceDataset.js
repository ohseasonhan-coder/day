...
const DEVELOPMENT_GROUPS = [
  ...
  },
  {
    key: 'habit', category: ['신체운동·건강'], situation: ['기본생활습관'],
    texts: [
      '{childName}는 일상생활 속에서 스스로 시도하는 발달 양상을 보이고 있으며, 앞으로 스스로 실천할 기회를 제공할 필요가 있습니다.',
      '신체운동·건강 영역에서 손 씻기와 정리 등 기본생활습관을 익혀 가는 모습이 나타나고 있습니다.',
      '{childName}는 식사와 휴식 등 일과에 스스로 참여하는 발달 경험을 하고 있습니다.',
      '{childName}는 교사의 안내를 통해 자조 능력을 넓혀 가는 모습을 보이고 있습니다.',
    ],
  },
  {
    key: 'support_change', category: ['사회관계', '신체운동·건강'], situation: ['교사지원변화'],
    texts: [
      '{childName}는 교사의 지원을 통해 어려운 활동에 도전하고 성취하는 발달 경험을 하고 있습니다.',
      '교사의 안내와 함께 스스로 시도하는 모습이 나타나며, 앞으로도 도전을 격려할 필요가 있습니다.',
      '{childName}는 교사의 격려 속에서 표현 방식을 넓혀 가는 발달 양상을 보이고 있습니다.',
      '{childName}는 교사의 정서적 지지를 통해 안정을 찾고 다시 시도하는 발달 경험을 하고 있습니다.',
    ],
  },
  {
    key: 'passive', category: ['사회관계'], situation: ['소극적참여'],
    texts: [
      '{childName}는 새로운 활동에 다가가는 데 시간이 필요한 모습이 있으나, 교사의 지원과 함께 참여를 넓혀 가고 있습니다.',
      '사회관계 영역에서 또래 놀이를 충분히 관찰한 뒤 참여하는 발달 양상을 보이고 있습니다.',
      '{childName}는 안정감을 바탕으로 점차 상호작용을 시도하는 모습을 보이고 있습니다.',
      '{childName}는 교사의 격려 속에서 편안하게 참여하는 발달 경험을 넓혀 가고 있습니다.',
    ],
  },
  {
    key: 'peer_adjust', category: ['사회관계'], situation: ['또래조율'],
    texts: [
      '{childName}는 또래와 의견을 조율하고 차례를 지키는 발달 양상을 보이고 있습니다.',
      '사회관계 영역에서 자신의 마음을 말로 표현하고 타협하는 모습이 나타나고 있습니다.',
      '{childName}는 교사의 중재와 함께 갈등을 조정하는 발달 경험을 하고 있습니다.',
      '{childName}는 친구의 입장을 듣고 함께 해결 방법을 찾아 가는 모습을 보이고 있습니다.',
    ],
  },
  {
    key: 'emotion', category: ['사회관계'], situation: ['감정표현'],
    texts: [
      '{childName}는 자신의 감정을 인식하고 표현하는 발달 양상을 보이고 있으며, 교사의 공감을 통해 안정을 찾아 가고 있습니다.',
      '사회관계 영역에서 감정을 말과 표정으로 나타내는 모습이 나타나고 있습니다.',
      '{childName}는 속상한 마음을 표현하고 도움을 청하는 발달 경험을 하고 있습니다.',
      '{childName}는 교사의 지원을 통해 감정을 조절해 가는 모습을 넓혀 가고 있습니다.',
    ],
  },
];
